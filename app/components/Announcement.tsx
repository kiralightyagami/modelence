...
export function Announcement() {
  return (
    <div className="relative flex h-fit w-full flex-col overflow-y-auto">
      <div className='shadow-input backdrop-blur-sm text-base mx-auto w-fit mb-6 rounded-full bg-white border border-neutral-200 dark:border-neutral-700 dark:bg-neutral-800 px-3 py-1'>
